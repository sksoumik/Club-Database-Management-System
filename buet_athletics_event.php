...
<title>buet_athletics_event</title>

</head>


<body>
<h2>BUET Athletics Club Events  </h2>
...
<tr>
   ...
   <?php
      ...
      $sql="SELECT club_id, event_name, location, sponsor from event where club_id='BUET01' ";       ///////////////// SQL QUERY ////////////////////
