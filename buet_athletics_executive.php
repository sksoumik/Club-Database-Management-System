...
<title>buet_athletics_executive</title>
...
<body>
<h2>BUET Athletics Club Executive Members </h2>
...
<tr>
   ...
   <?php
      ...
      $sql="SELECT   member.member_id,member.member_fname, member.club_id, executive.role, executive.session
      from member,executive
      where member.member_id=executive.member_id and member.club_id='BUET01' 
      order by session desc";      ///////////////// SQL QUERY ////////////////////
