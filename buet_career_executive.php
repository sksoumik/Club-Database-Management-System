...
<title>buet_career_executive</title>
...
<body>
<h2>BUET Career Club Executive Members </h2>
...
<tr>
   ...
   <?php
      ...
      where member.member_id=executive.member_id and member.club_id='BUET02' 
      order by member_id";      ///////////////// SQL QUERY ////////////////////
